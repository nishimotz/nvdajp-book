...
- B その他 折りたたみ
- B 1-5 / 5 ボタン 折りたたみ（表示されているメッセージの数／すべてのメッセージの数）
- B 前
- B 次
- B 設定 折りたたみ
- D 2 メイン スレッド
...
### 3.13 Gmail でメールを作成する


### 3.14 Gmail のスレッド詳細画面
...
-- K プライバシー
-- K アカウント アクティビティの詳細
-- D 補足情報 誰々さんのプロフィール写真
--- B Google+に参加
--- B 誰々さんとハングアウト
--- B 誰々さんとのビデオ ハングアウトを開始
--- B 誰々さんにメールを送信
--- B その他の操作 折りたたみ
--- K 詳細を表示
```
