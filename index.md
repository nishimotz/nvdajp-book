...
### 4.3 ナビゲーターオブジェクトのボタンを押す

ナビゲーターオブジェクトがボタンにあるときに、そのボタンを押すための操作を二通り説明します。

これらは Tab キーで移動できないボタンを押すときに有効なので、練習をしてみましょう。
...
この「閉じる　ボタン」のもうひとつ上の階層は「ファイル名を指定して実行　ウィンドウ」です。
...
ここでは Windows のダイアログボックスの一般的な操作をまとめます。

Windows+R で「ファイル名を指定して実行」を開いて再確認してください。
...
ここでは Windows 10 バージョン 1703 の「設定」で役に立ちそうなものを紹介します。


#### 5.3.1 既定のアプリの設定


#### 5.3.2 Windows Update 


#### 5.3.3 トラブルシューティングツール
