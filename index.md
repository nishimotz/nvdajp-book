...
- NVDA+N を押して「NVDAメニュー」と読み上げられることを確認
- 下矢印を3回押して「ヘルプ(H) サブメニュー」と読み上げられることを確認
- 右矢印を押す（サブメニューが開いて先頭項目にフォーカスが移動）
- 下矢印を押して「ユーザーガイド(U)」と読み上げられることを確認
- Enter を押してメニュー項目を選択


なお、アクセラレーターキーを使うと、以下のように操作できます：
