...
- このコンピューターにインストールする
- ポータブル版を作成する
- 使用を継続してそのまま NVDA を使う

コンピューターに NVDA をインストールすることを選ぶと、
次の画面に「ログオン画面で NVDA を使用する」というチェックボックスがあります。
...
これを押すと
「トップ 見出し レベル1 NVDA 2014.4jp ユーザーガイド」
と読み上げます。
繰り返しても読み上げる内容は同じです。
これは、レビューカーソルが一番上の行にあって、
その行が「見出しレベル1」という種類の情報で、
内容が「NVDA 2014.4jp ユーザーガイド」であることを示しています。
...
これを押すと
「見出し レベル1 NVDA 2014.4jp ユーザーガイド」
と読み上げます。
...
しかし例えば Firefox バージョン 30.0 は Windows XP SP2 から Windows 8.1 まで利用できます。
...
練習のためには例えば「日付と時刻の通知」を NVDA+Z に割り当てる、
といった設定をしてみてはどうでしょうか。
