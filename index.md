...
それは「リスト項目」の話です。
レビューカーソルは「リスト項目」の中の文字を一つ一つ確認できるのです。
...
ここでは Windows 10 （デスクトップモード）のスタートメニューを紹介します。

Windows キーを押すとスタートメニューが表示されます。
...
- 項目ビュー
- 項目ビューのレイアウトが「詳細」の場合は「名前 スプリットボタン」
- 表示モード
...
- リボンが展開済み：Alt を押すと「ホーム」に移動
- リボンが折りたたみ済み：Alt を押すと「ファイル」に移動
